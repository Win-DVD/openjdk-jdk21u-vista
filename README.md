...
fair notice if you want to play minecraft 1.21+
LWJGL 3.3.3 is incompatible with stock Vista by default, You must use a launcher like "Prism Launcher" to replace the OpenAL.dll with the one from LWJGL 3.3.1.
